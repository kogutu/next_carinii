...
type PriceRangeMap = Record<string, [number, number]> // np. { price: [100, 500] }
...
interface CategoryState {
    ...
    totalItems: number
    isLoading: boolean
    categoryId: string          // FIX: zawsze string
    itemsPerPage: number
    fields: FilterFields
    priceRange: PriceRangeMap   // FIX: spójny typ z encode/decode
    page: number
    sort: SortOption
    isInitialized: boolean
    filters: FilterFields       // FIX: Record, nie any
...
export const useCategoryZustand = create<CategoryState>()(
    ((set, get) => ({
        ...
        facets: [],
        totalItems: 0,
        categoryId: "0",          // FIX #1: string, nie number
        selectedFiltersURL: {},
        filters: {},              // FIX #3: obiekt, nie tablica
        isLoading: false,
        itemsPerPage: startItemPerPage,
        fields: {},
        priceRange: {},           // FIX #5: pusty obiekt, nie null (spójne z Record<string, [number, number]>)
        page: 1,
        sort: "createdat:desc",
        isInitialized: false,
        ...
        initializeStore: (config: CategoryConfig, fetch = true) => {
            ...
            // console.log(window.location.search, restored);


            // set({ selectedFiltersURL: restored })
            console.log
            set({
                filters: {},
        ...
        // FIX #4: resetFilters teraz resetuje TAKŻE filters (nie tylko fields)
        resetFilters: () => {
            set({
                fields: {},
                filters: {},        // FIX #4: dodane
                priceRange: {},     // FIX #5: pusty obiekt zamiast null
                page: 1,
            })
...
export function decodeFiltersFromUrl(
    ...
    // FIX #6: jeden obiekt zamiast dwóch (filters + fs)
