...
export default function ProductsCarousel({ title, products, viewAllUrl = '#' }: ProductCarouselProps) {
              ...
              <div className="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-xl transition-all duration-300 h-full flex flex-col cursor-pointer">
                ...
                <div className="relative bg-gray-100 h-32 sm:h-40 md:h-48 flex-shrink-0">
                  <img
                    ...
                    alt={product.name}
                    className="w-full h-full object-contain brightness-[0.96]"
                ...
                <div className="p-2 sm:p-3 md:p-4 flex-grow flex flex-col justify-between">
                  ...
                  {product.hidePrice === false && (
                    <div>
                      <p className="text-purple-900 font-bold text-xs sm:text-sm mb-0.5 sm:mb-1">
                        {product.priceNet} zł
                      </p>
                      <p className="text-gray-600 text-[10px] sm:text-xs">{product.priceGross} zł brutto</p>
                    </div>
                  )}
                </div>
              </div>
