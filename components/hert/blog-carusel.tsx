...
import PostPageItem from '@/pages/postpage-item';
...
export default function PostPageCarousel({ title, products, viewAllUrl = '#' }: ProductCarouselProps) {
        ...
        >
          {products.map((product) => (
            ...
            >
              ...
              <PostPageItem key={product.id} post={product}  ></PostPageItem>
