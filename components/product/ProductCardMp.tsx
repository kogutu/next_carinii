                    ...
                    <div className="flex items-center gap-1.5 justify-center w-full">
                        ...
                        <div className="flex items-center gap-1 justify-center w-full">
                            {discountAmount > 0 && (
                                ...
                                <Badge variant="secondary" className="bg-destructive text-primary-foreground font-bold text-xs px-1.5 py-0">
                                    - {discountAmount ?? 0} zł
                                </Badge>
                            )}

                            {deliveryTime == "24h" && (
                                <Badge variant="secondary" className="bg-mpgreen text-white font-bold text-xs px-1.5 py-0">
                                    <Truck className="h-3 w-3" />  {deliveryTime}
                                </Badge>
                            )}
                            ...
                            {product.qty < 5 && (
                                <Badge
                                    variant="secondary"
                                    className="bg-destructive text-primary-foreground bg-mpgray font-bold text-xs px-1.5 py-0"
                                >
                                    OSTANIE SZTUKI
                                </Badge>
                            )}
