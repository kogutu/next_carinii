...
const TYPESENSE_API_URL = "https://www.hert.pl/typesense/api"

const COLLECTION_MEBLE = "hert"
const COLLECTION_CATEGORIES = "hert_categories"
...
export async function searchProducts(
    ...
    try {
        ...
        console.log(`${TYPESENSE_API_URL}/collections/${COLLECTION_MEBLE}/documents/search?${params.toString()}`);

        const response = await fetch(`${TYPESENSE_API_URL}/collections/${COLLECTION_MEBLE}/documents/search?${params.toString()}`, {
            method: "GET",
            headers: {
...
export async function searchCategories(
    ...
    try {
        ...
        console.log(`${TYPESENSE_API_URL}/collections/${COLLECTION_CATEGORIES}/documents/search?${params.toString()}`);


        const response = await fetch(
            `${TYPESENSE_API_URL}/collections/${COLLECTION_CATEGORIES}/documents/search?${params.toString()}`,
            {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
